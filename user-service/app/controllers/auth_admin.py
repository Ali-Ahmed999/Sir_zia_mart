...
def admin_verify(admin_form: AdminLoginForm, session: DB_SESSION):
    ...
    Args:
        admin_form (AdminLoginForm): The admin form from the request.
        session (DB_SESSION): The database session.

    Returns:
        dict: A dictionary with the admin token and type.

    Raises:
        HTTPException: Raised if the admin secret key is not valid or the admin is not found.

    """
##******  299e6b57-b4bc-4bf9-a45a-f2a318d95580  *******/ 
